...
## Planned coverage
- Single Responsibility Principle — with before/after C# refactor examples
- Open/Closed Principle — strategy pattern as the canonical fix
- Liskov Substitution Principle — subtle violations (e.g. throwing `NotImplementedException` in overrides)
