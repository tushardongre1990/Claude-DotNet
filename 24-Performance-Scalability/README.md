...
- Common ASP.NET Core performance pitfalls: sync-over-async, unbounded thread pool growth, large object allocations, chatty DB calls (ties into [[13-EntityFramework-Core]])
...
- Caching as a scalability lever (ties into [[15-Caching-Strategies]])
- Backpressure and rate limiting under load (ties into [[18-API-Design-Best-Practices]])
